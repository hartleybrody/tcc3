# Django settings for tcc3 project.

ADMINS = (
    ('Hartley', 'thecollegecartel+django@gmail.com'),
)
...
SECRET_KEY = '-aq8etr3^+rbn1-p!_4cnrq)9+rl(-2ke7sg9%d2b_=v8+2#-t'
...
import os.path # nifty trick from http://www.djangobook.com/en/2.0/chapter04/
...
import socket # trick from http://www.djangobook.com/en/2.0/chapter12/ for selecting env
if socket.gethostname() == 'HB0426-SSD':
